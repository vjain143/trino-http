...
public class TestClient
{
            ...
            throws Exception
    {
        ...
        Client client = new Client(new Config().setMetadata(metadata), CATALOG_CODEC);
        ...
        Table table = client.getTable("example", "numbers");
        assertNotNull(table, "table is null");
        assertEquals(table.getName(), "numbers");
        assertEquals(table.getColumns(), ImmutableList.of(new Column("text", createUnboundedVarcharType()), new Column("value", BIGINT)));
