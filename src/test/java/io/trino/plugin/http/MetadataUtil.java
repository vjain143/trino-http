...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<Map<String, List<Table>>> CATALOG_CODEC;
    public static final JsonCodec<Table> TABLE_CODEC;
    public static final JsonCodec<ColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(Table.class));
        TABLE_CODEC = codecFactory.jsonCodec(Table.class);
        COLUMN_CODEC = codecFactory.jsonCodec(ColumnHandle.class);
    }
